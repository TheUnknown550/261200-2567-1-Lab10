...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        ExecutableMid Mid = new ExecutableMid(new Turtle());
        ExecutableLeft Left = new ExecutableLeft(new Turtle());
        ExecutableRight Right = new ExecutableRight(new Turtle());

        Thread midThread = new Thread(Mid);
        Thread rightThread = new Thread(Right);
        Thread leftThread = new Thread(Left);

        // this is creating turtles concurrently
        midThread.start();
        rightThread.start();
        leftThread.start();
